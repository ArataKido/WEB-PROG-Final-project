...
def about(request):
    ...
    Returns:
        str: If the django is requesting GET then function will route user to the page about.html
            and at the same time it will create a form. In addition it sends an instance which will display comments
            from database
